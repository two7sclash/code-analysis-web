...
},{"./fp-debug":1}],3:[function(require,module,exports){
/*
 * Fuzzy
...
const App = React.createClass({
    ...
    render() {
        ...
        }, null, 'Shuffle'), React.DOM.button({
            key: 'sort-first',
            onClick: this._sortByFirst
        }, null, 'Sort (First Name)'), React.DOM.button({
            key: 'sort-last',
...
},{"functional-pipeline":2,"fuzzy":3,"lodash":4}]},{},[5]);
